"""Developer-installable asynchronous timer tool."""
...
class TimerTool(AsyncTool):
    ...
    When ``reminder_interval_seconds`` is provided, immediately call
    ``subscribe_async_tool`` with the tool call ID from the initial result.
    After subscription succeeds, wait for progress updates instead of polling.
    """
