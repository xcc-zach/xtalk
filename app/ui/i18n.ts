...
const zhCN = {
  ...
  "language.en": "English",
  "wakeWord.title": "语音唤醒",
  "wakeWord.enable": "语音唤醒",
  "wakeWord.enableLabel": "语音唤醒",
  "wakeWord.phrase": "唤醒词",
  "wakeWord.phrasePlaceholder": "输入中文或英文唤醒词",
  "wakeWord.threshold": "阈值",
  ...
  "sleep.wakeDisabled": "无法进入沉睡模式：请先开启语音唤醒。",
  "sleep.backgroundFailed": "无法进入沉睡模式：{{error}}",
  "model.title": "模型配置",
  "model.current": "当前配置",
  "model.none": "未选择",
...
const en: Record<keyof typeof zhCN, string> = {
  ...
  "language.zhCN": "简体中文",
  "language.en": "English",
  "wakeWord.title": "Voice wake",
  "wakeWord.enable": "Voice wake",
  "wakeWord.enableLabel": "Voice wake",
  "wakeWord.phrase": "Wake phrase",
  "wakeWord.phrasePlaceholder": "Enter a Chinese or English wake phrase",
  "wakeWord.threshold": "Threshold",
  ...
  "sleep.wakeDisabled": "Could not enter sleep mode: enable voice wake first.",
  "sleep.backgroundFailed": "Could not enter sleep mode: {{error}}",
