...
const zhCN = {
  ...
  "language.zhCN": "简体中文",
  "language.en": "English",
  "wakeWord.title": "后台语音唤醒",
  "wakeWord.enable": "启用后台语音唤醒",
  "wakeWord.enableLabel": "启用后台语音唤醒",
  "wakeWord.description": "关闭窗口后继续在本机监听唤醒词，不保存或上传音频。",
  "wakeWord.phrase": "唤醒词",
  "wakeWord.loading": "正在读取语音唤醒状态",
  "wakeWord.disabled": "已关闭；关闭窗口时将退出 XTalk",
  "wakeWord.starting": "正在启动本地唤醒词检测",
  "wakeWord.listening": "正在后台监听“{{phrase}}”",
  "wakeWord.paused": "对话期间已暂停后台监听",
  "wakeWord.error": "语音唤醒不可用：{{error}}",
  "wakeWord.updateFailed": "无法更新语音唤醒设置：{{error}}",
  "wakeWord.detected": "已听到“{{phrase}}”，正在开始对话",
  "wakeWord.stateDisabled": "关闭",
  "wakeWord.stateStarting": "启动中",
  "wakeWord.stateListening": "监听中",
  "wakeWord.statePaused": "已暂停",
  "wakeWord.stateError": "错误",
  "model.title": "模型配置",
  "model.current": "当前配置",
  "model.none": "未选择",
...
const en: Record<keyof typeof zhCN, string> = {
  ...
  "language.zhCN": "简体中文",
  "language.en": "English",
  "wakeWord.title": "Background voice wake",
  "wakeWord.enable": "Enable background voice wake",
  "wakeWord.enableLabel": "Enable background voice wake",
  "wakeWord.description":
    "Keep listening locally after the window closes. Audio is neither stored nor uploaded.",
  "wakeWord.phrase": "Wake phrase",
  "wakeWord.loading": "Loading voice-wake status",
  "wakeWord.disabled": "Off; closing the window will exit XTalk",
  "wakeWord.starting": "Starting local wake-word detection",
  "wakeWord.listening": "Listening for “{{phrase}}” in the background",
  "wakeWord.paused": "Background listening is paused during the conversation",
  "wakeWord.error": "Voice wake is unavailable: {{error}}",
  "wakeWord.updateFailed": "Could not update voice-wake settings: {{error}}",
  "wakeWord.detected": "Heard “{{phrase}}”; starting a conversation",
  "wakeWord.stateDisabled": "Off",
  "wakeWord.stateStarting": "Starting",
  "wakeWord.stateListening": "Listening",
  "wakeWord.statePaused": "Paused",
  "wakeWord.stateError": "Error",
