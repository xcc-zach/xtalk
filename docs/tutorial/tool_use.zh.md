...
如果您希望每个会话中的工具都维持彼此独立的内部状态，也可以使用工具工厂（参见 `examples/sample_app/mental_consultant_server.py` 中的 `build_mental_questionnaire_tool`）。

## 内置工具

> **Note**
> 所有内置工具请参阅 `src/xtalk/models/agents/tools` 下的源码。
